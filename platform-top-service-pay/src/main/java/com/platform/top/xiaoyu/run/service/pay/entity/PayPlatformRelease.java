...
@TableName(TableNameConstant.PLATFORMRELEASE_TABLENAME)
@ApiModel(value = "PayPlatformRelease", description = "第三方支付平台发布")
public class PayPlatformRelease extends BaseEntity<Long> {
    ...
    @ApiModelProperty(value = "支付类型  例： mango支付平台==》 963 银联扫码/云闪付   972 支付宝  975 支付宝转卡 扫码方式  985 微信转卡  986 zfb转卡 跳转页面")
