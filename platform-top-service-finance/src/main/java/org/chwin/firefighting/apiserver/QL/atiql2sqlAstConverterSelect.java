...
public class atiql2sqlAstConverterSelect extends atiql2sqlAstConverterBase {
    PlainSelect PlainSelect1 = new PlainSelect();
    private Function atiqlAst1;

    atiql2sqlAstConverterSelect() {
    ...
    public Statement toSqlAst(Function atiqlAst) {
        ...
        traveTree(atiqlAst);
        atiql2sqlAstConverterSelect c = new atiql2sqlAstConverterSelect();
...
//        ps.    setFromItem(new Table(table));
    ...
    public void traveTree(Expression atiqlAstTmp) {
        ...
        if (atiqlAstTmp instanceof Function) {
            Function f = (Function) atiqlAstTmp;
